...
const vi: TranslationKeys = {
  ...
  buyGold: {
    ...
    buySuccessTitle: 'Mua vàng thành công!',
    buySuccessSubtitle: 'Bạn đã sở hữu thêm {{amount}}g vàng',
    authReason: 'Xác nhận để thực hiện mua vàng',
  ...
  allocateGold: {
    ...
    heistTitle: 'Chế độ Trộm: Đột nhập rút Vàng',
    heistSubtitle: 'Rút vàng từ heo đất này về ví chính của bạn',
    heistConfirm: 'Bắt đầu Heist',
    heistSuccess: 'Heist thành công! 🎉',
    heistSuccessTitle: 'Đã rút vàng thành công!',
    heistSuccessSubtitle: 'Vàng đã được chuyển ngược lại vào ví chính của bạn.',
    missionComplete: 'Nhiệm vụ hoàn tất',
    bypassSecurity: 'ĐÃ VƯỢT RÀO BẢO MẬT',
    successTitle: 'Xong!',
  ...
  walletScreen: {
    ...
    withdrawSheetTitle: 'Rút USDC',
    withdrawSheetSubtitle: 'Rút tiền về ví Solana bên ngoài',
    ...
    withdrawConfirm: 'Ký & Rút tiền',
    withdrawSuccessTitle: 'Rút tiền thành công!',
    depositSuccessTitle: 'Giao dịch thành công!',
  ...
  profile: {
    ...
    touchid: 'Vân tay',
    passcode: 'Mật mã',
    biometricsFallback: 'Sử dụng mật mã',
    biometricsCancel: 'Hủy',
    ...
    version: 'Vàng Heo Đất Phiên bản {{version}}',
